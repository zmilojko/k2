@roi_cross_sulanmaan_.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    * Muuta: Kilpailut pidetään Rovaniemellä Pöyliövaaran hiihtolatupohjalla. Ajo-ohjeet toimitetaan kisakirjeessä kilpailijoille tai pyydettäessä sähköpostiin.
    ...
    PAGE
@robur_sprint_.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    Robur sprint, 3-4.1. Järjestäjä Sisuva. SP4, SP8 ja koirahiihdot
    
    PAGE
@robur_sprint_.pages.create! name: "Info",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@ruuhirod_.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@ruuhirod_.pages.create! name: "Info",
  content: <<-PAGE.strip_heredoc
    # Ruuhirod 2015
    ...
    PAGE
@ohkolan_talvi.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@eastpoint_open.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    ** Checkpointilta startatessa valjakossa on oltava vähintään 6 koiraa (kilpailukohtainen 
    ...
    PAGE
@metsakartano_race_sm.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@_ifss_european_champ.pages.create! name: "Welcome",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@_ifss_european_champ.pages.create! name: "Information",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@ruunaa_race.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@_taivalvaara_sled_do.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@shs_metsakartano_spr.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
    ...
    PAGE
@kuusamo_sprinti.pages.create! name: "Tervetuloa",
  content: <<-PAGE.strip_heredoc
